...
class ModelConfig(DefaultModelConfig):
    def __init__(self):
        ...
        self.MODEL_DECODER = 'diffusion'
        self.MODEL_DECODER_DIFF_MODEL = "UNet"
        self.MODEL_DECODER_SCHEDULE = "DDPM"
        self.MODEL_CONDITION_DIM = 512
        self.MODEL_DECODER_TIMESTEP = 50
        self.MODEL_DECODER_GUIDANCE_SCALE = 0.5
        self.MODEL_DECODER_GENERATE_SEED = 0
