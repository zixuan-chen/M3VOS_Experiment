...
def vos_inference(
    ...
    frame_names.sort(key=lambda p: int(os.path.splitext(  extract_numbers(p)[0])[0]))
    ...
    for out_frame_idx, per_obj_output_mask in video_segments.items():
        ...
        if to_save_frame_list and frame_names[out_frame_idx] not in to_save_frame_list:
            continue
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="json file to determine which frame to save (Only for YoutubeVOS)",
    ...
    req_frame_list = None
    if args.youtube_meta_file is not None:
        req_frame_list = {}

        with open(args.youtube_meta_file) as f:
    ...
    for n_video, video_name in enumerate(video_names):
        ...
        vos_inference(
            ...
            to_save_frame_list=req_frame_list[video_name],
        )
