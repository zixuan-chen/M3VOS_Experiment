...
from cutie.model.utils.parameter_groups import get_parameter_groups, get_parameter_groups_readout_fuser
...
class Trainer:
    def __init__(self, cfg: DictConfig, stage_cfg: DictConfig, log: TensorboardLogger, run_path):
        ...
        parameter_groups = get_parameter_groups_readout_fuser(self.cutie, stage_cfg, print_log=(local_rank == 0))
    ...
    def train_voter(self):
        ...
        for param in self.cutie.parameters():
            param.requires_grad = False
        # Unfreeze parameters of the voter module
        for param in self.cutie.module.voter.parameters():
