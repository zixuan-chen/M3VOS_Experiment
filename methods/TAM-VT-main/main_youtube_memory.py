...
from engine_unified_eval_vost_memory import evaluate_roves as evaluate_roves
...
def evaluate(
    ...
    elif task == "roves" or task == "davis"  or task == "youtube":
        evaluate_roves(
            model=model,
            postprocessors=postprocessors,
            data_loader=data_loader,
...
def main(args):
    ...
    for task in args.val_tasks.names:
    ...
    def build_evaluator_list(dataset_name):
        ...
        evaluator_list = []
        if "vost" in dataset_name or "roves" in dataset_name  or "davis" in dataset_name  or "youtube" in dataset_name:
