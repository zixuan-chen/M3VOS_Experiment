...
if __name__ == "__main__":
    ...
    parser.add_argument('--images_folder', type=str, default="VOST/JPEGImages", help='Path to the folder containing original image folders')
    ...
    parser.add_argument('--output_exp', type=str, default="/path/to/Cutie_base1080p_merge_video", help='Path to the folder where the output videos will be saved')
