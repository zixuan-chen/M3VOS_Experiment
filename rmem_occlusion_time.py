...
def make_masked_frame(frame, left=100, top=100, right=200, bottom=200):
    ...
    # 将T时刻的帧复制到黑色图像上
    masked_frame += frame
    masked_frame = cv2.rectangle(masked_frame, (left, top), (right, bottom), (255, 255, 255), thickness=2)
    return masked_frame
...
if __name__ == "__main__":
    ...
    seq_dataset = make_masked_video_dataset(seq_name, 
                                            start_time=5,
                                            )